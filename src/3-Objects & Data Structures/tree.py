#Bunu yaptık derste, ama tek bir yeri anlamadım. Tree class'ında, insert fonksiyonu neden O(log(n)) complexity'ye sahip?
#O(n) olmamasını anlıyorum, tree'de hepsine bakmadan insert edeceğiz ama log n kuralını çıkaramadım.
